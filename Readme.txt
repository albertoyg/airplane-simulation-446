...
You may change the size of the aircraft by changing the values in the plane_size dictionary. Note the dictory uses values (rows, cols) where cols only refer to the number of columns on one side of the aisle. 